...
<accent-switcher hidden>
            <fieldset>
            <legend><h4 class="line">Accent colour</h4></legend>
            <div class="cluster">
...
<p><small>&copy; Chris Pymm <?= date('Y') ?></small></p>
</section>
